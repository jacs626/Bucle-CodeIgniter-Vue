...
class MetaFieldTypeBuilder {
  ...
  private registerDefaults() {
    this.register({
      ...
      render: (v, onChange) =>
        `<input type="text" value="${v ?? ""}" onchange="onChange(this.value)" />`,
    });
    ...
    this.register({
      ...
      render: (v, onChange) =>
        `<input type="number" value="${v ?? 0}" onchange="onChange(Number(this.value))" />`,
    });
    ...
    this.register({
      ...
      hasOptions: false,
      defaultValue: () => 0.0,
      normalize: (v) => parseFloat(String(v)) || 0.0,
      render: (v, onChange) =>
        `<input type="number" step="0.01" value="${v ?? 0.0}" onchange="onChange(parseFloat(this.value))" />`,
    });
    ...
    this.register({
      ...
      render: (v, onChange) =>
        `<button type="button" onclick="onChange(!${v})">${v ? "Sí" : "No"}</button>`,
    });
    ...
    this.register({
      ...
      normalize: (v) => String(v ?? ""),
      render: (v, onChange) =>
        `<input type="date" value="${v ?? ""}" onchange="onChange(this.value)" />`,
    });
    ...
    this.register({
      ...
      normalize: (v) => String(v ?? ""),
      render: (v, onChange) =>
        `<select onchange="onChange(this.value)"><option value="">Seleccionar...</option></select>`,
    });
    ...
    this.register({
      ...
      normalize: (v) => String(v ?? ""),
      render: (v, onChange) =>
        `<input type="email" value="${v ?? ""}" onchange="onChange(this.value)" />`,
    });
    ...
    this.register({
      ...
      normalize: (v) => String(v ?? ""),
      render: (v, onChange) =>
        `<input type="url" value="${v ?? ""}" onchange="onChange(this.value)" />`,
    });
    ...
    this.register({
      ...
      normalize: (v) => String(v ?? ""),
      render: (v, onChange) =>
        `<input type="tel" value="${v ?? ""}" onchange="onChange(this.value)" />`,
    });
  }
